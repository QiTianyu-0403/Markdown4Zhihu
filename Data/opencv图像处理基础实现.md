...
![img](opencv图像处理基础实现/wpsAP36hh.jpg)

2、灰度处理

![img](opencv图像处理基础实现/wps2Ghw6Y.jpg)

3、边缘检测（Sobel算子）

![img](opencv图像处理基础实现/wpsY4qyFz.jpg)

4、添加噪声（椒盐噪声）

![img](opencv图像处理基础实现/wpsZMyoev.jpg)

5、滤波处理（中值滤波）

![img](opencv图像处理基础实现/wpspI8TOQ.jpg)

6、滤波处理（形态学滤波）

![img](opencv图像处理基础实现/wpsFTtxkC.jpg)

7、双目摄像机标定

![img](opencv图像处理基础实现/wpsOcmFzT.jpg)

8、图像变换（透视变换）

![img](opencv图像处理基础实现/wpstXDt1S.jpg)

9、阈值分割（OSTU）

![img](opencv图像处理基础实现/wpsGFOoJC.jpg)

10、高斯混合背景

![img](opencv图像处理基础实现/wpscem4YS.jpg)

11、模板匹配

![img](opencv图像处理基础实现/wpszJQRf8.jpg)

12、隐身效果

![img](opencv图像处理基础实现/wpsCKgaTV.jpg)

13、颜色匹配

![img](opencv图像处理基础实现/wpsaJBtFz.jpg)

14、特征提取（SIFT）

![img](opencv图像处理基础实现/wpsPEKJ1W.jpg)
